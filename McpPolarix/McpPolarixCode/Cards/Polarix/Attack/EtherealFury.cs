...
public class EtherealFury() : PolarixCard(1,
    ...
    TargetType.AnyEnemy)
{
    ...
    [
        ...
        new CalculatedDamageVar(ValueProp.Move).WithMultiplier((Func<CardModel, Creature, decimal>) ((card, creature) => PileType.Exhaust.GetPile(card.Owner).Cards.Count))
    ];
