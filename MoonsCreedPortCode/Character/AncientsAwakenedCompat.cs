...
public static class AncientsAwakenedCompat
{
    ...
    public static bool RegisterPerfectedStrikeForCoco(
        CharacterModel charModel, CardModel flawedStrikeCard, CardModel perfectedStrikeCard)
    {
    ...
    public static bool RegisterPerfectedDefendForCoco(CharacterModel charModel, CardModel flawedDefendCard, CardModel perfectedDefendCard)
    {
    ...
    public static bool RegisterExperimentalSerumCardForCoco(CharacterModel charModel,
        CardModel cardModel)
    {
        ...
        ModelId perfectedCardId)
    {
        ...
        ModelId characterId = charModel.Id;
